...
export function LaunchButton(): JSX.Element {
  ...
  const launch = useCallback(async () => {
    ...
    try {
      const agent = selectedAgent === "opencode" ? "opencode" : "claude-code";
    ...
    task, projectPath, selectedAgent, clearLogs, setResultZh, setSummaryTranslation, setEmotionText,
    setSuggestionOptions, setMode, setAgentStatus, setPercent, setUiState, setLastStage, setBubble,
